    ...
    return (
      <Box sx={{ p: 4 }}>
        ...
        <Typography variant="body1" sx={{ mb: 4 }}>
          The Student Data System (SDS) is your central platform for managing academic activities, accessing resources, and staying updated with important information.
        </Typography>
        ...
        <List sx={{ bgcolor: 'background.paper', boxShadow: 2, borderRadius: 1, mb: 4 }}>
