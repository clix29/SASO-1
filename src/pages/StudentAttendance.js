              ...
              >
                    ...
                    sx={{
                      ...
                      borderTop: `10px solid ${
                        overallAttendance.percentage >= 90
                          ? "#4caf50"
                          : overallAttendance.percentage >= 80
                          ? "#2196f3"
                          : overallAttendance.percentage >= 70
                          ? "#ff9800"
                          : "#f44336"
                      }`,
                ...
                <Box sx={{ mt: 2, textAlign: "center" }}>
                  <Typography variant="body1" sx={{ mb: 1 }}>
                    {overallAttendance.attended} of {overallAttendance.total} sessions
                    attended
                  </Typography>
                  <Chip
            ...
            <Grid item xs={12} md={4}>
              ...
              >
                ...
                <Box sx={{ mb: 2, flex: 1 }}>
                  ...
                  <Typography variant="body2" sx={{ mb: 2 }}>
                    Falling below 75% attendance may result in academic penalties and may
                    affect your eligibility to sit for examinations.
                  </Typography>
                  <Typography variant="body2">
                    Medical absences require appropriate documentation to be submitted
                    within 7 days.
                  </Typography>
                </Box>
                <Box sx={{ mt: "auto" }}>
